...
class PlaylistMetadataEntry(@field:ColumnInfo(name = PLAYLIST_ID)
                            val uid: Long, @field:ColumnInfo(name = PLAYLIST_NAME)
                            val name: String, @field:ColumnInfo(name = PLAYLIST_THUMBNAIL_URL)
                            val thumbnailUrl: String, @field:ColumnInfo(name = PLAYLIST_STREAM_COUNT)
                            val streamCount: Long) : PlaylistLocalItem {
